...
from app import db
from app.vendas import bp
from app.vendas.forms import VendaForm, PagamentoForm
from app.models import Cliente, Produto, Venda, ItemVenda, Pagamento, FluxoCaixa, Caixa
